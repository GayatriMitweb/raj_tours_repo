...
function report_reflect()
{
	...
	$.post('report_reflect/taxation_reports/vat_payable_report/report_reflect.php',{ taxation_id : taxation_id,gl_id : gl_id, from_date : from_date, to_date : to_date, financial_year_id : financial_year_id,branch_status : branch_status, role : role,branch_admin_id : branch_admin_id }, function(data){
		pagination_load(data, column, true, false, 20, 'gst_on_sale');
	});
}
...
function excel_report()
{
	...
	window.location = 'report_reflect/taxation_reports/vat_payable_report/excel_report.php?from_date='+from_date+'&to_date='+to_date+'&branch_status='+branch_status+'&branch_admin_id='+branch_admin_id+'&role='+role+'&taxation_id='+taxation_id;
}
report_reflect();
</script>
