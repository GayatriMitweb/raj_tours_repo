      ...
      <div class="modal-body">
        ...
        <legend>Quotation Details</legend>   
          <div class="row">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
              <input type="text" id="to_date1" name="to_date1" placeholder="To Date" title="To Date"  class="form-control" value="<?= date('d-m-Y', strtotime($sq_enq_info['to_date'])) ?>" onchange="total_days_reflect('1');calculate_total_fees(this.id, '1')">
            </div>
            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
