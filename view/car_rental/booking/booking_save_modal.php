      ...
      <div class="modal-body">
        ...
        <div class="panel panel-default panel-body app_panel_style feildset-panel">
         <legend>Quotation Details</legend>
          ...
          <div class="row">
            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
              <input type="text" id="from_date" name="from_date" placeholder="From Date" title="From Date" value="<?= date('d-m-Y')?>" class="form-control" onchange="total_days_reflect();;calculate_total_fees(this.id)">
            </div> 
          
            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
              <input type="text" id="to_date" name="to_date" placeholder="To Date" title="To Date" value="<?= date('d-m-Y')?>" class="form-control" onchange="total_days_reflect();calculate_total_fees(this.id)">
            </div>
            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
...
$('#from_date,#to_date,#traveling_date').datetimepicker({ format:'d-m-Y' });
