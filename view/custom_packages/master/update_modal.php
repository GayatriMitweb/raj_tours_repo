        ...
        <?php
          ...
          ?>
              <tr>
                  ...
                  <td><input maxlength="15" value="<?php echo $count_hotel; ?>" type="text" name="no" placeholder="Sr. No." class="form-control" disabled /></td>           
                  <td class="col-md-3"><select name="vehicle_name1-u" id="vehicle_name1<?php echo $count_hotel; ?>-u" style="width:250px" class="form-control app_select2" onchange="get_transport_cost(this.id)">
